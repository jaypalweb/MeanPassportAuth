...
start /d "C:\Program Files\ConEmu\" ConEmu64.exe /cmdlist ^> cmd -cur_console:t:"Project":d:C:\MyLearn\MeanPassportAuth  ^|^|^| cmd -cur_console:t:"NodeBackend":d:C:\MyLearn\MeanPassportAuth\expressapp /k "npm start" ^|^|^| cmd -cur_console:t:"AngularFrontend":d:C:\MyLearn\MeanPassportAuth\frontend /k "ng serve"
